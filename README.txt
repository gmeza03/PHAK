...
EJECUTAR ARCHIVOS .PY
  ...
  requests: 
      (tiene 2 metodos, te dare los 2)
      DNF: sudo dnf install python3-requests
      PIP: sudo dnf install python3-pip, pip install requests

    geocoder:
      (igual tiene 2 metodos, intenta los 2)

      DNF: sudo dnf install python3-geocoder
